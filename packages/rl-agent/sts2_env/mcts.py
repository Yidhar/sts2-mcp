...
from .semantic_action import SEMANTIC_ACTION_FAMILIES, SEMANTIC_ROLE_NAMES, SEMANTIC_TARGET_SCOPES
from .semantic_rollout import SEMANTIC_ROLLOUT_SIZE
...
class MCTS:
        ...
        for raw_index in legal_indices.tolist():
            ...
            if semantic_row is not None and semantic_row.shape[0] > role_scaling:
                semantic_positive = bool(
                    ...
                    or semantic_row[family_use_potion] > 0.5
                )
                setup_scaling = bool(
    ...
    def run(
        ...
        if len(legal_actions) == 1:
            ...
            self.last_run_stats = {
                ...
                "semantic_rollout_enabled": 1.0 if self._semantic_rollout_enabled else 0.0,
        ...
        for _ in range(num_simulations):
            ...
            if action_idx is None:
                ...
                semantic_switch = (
                    ...
                    and self._semantic_rollout_enabled
    ...
    def _expand(
        ...
        *,
        ...
        switch_to_semantic = self._semantic_rollout_enabled and child_depth >= self.semantic_switch_depth
        child.reward = reward
