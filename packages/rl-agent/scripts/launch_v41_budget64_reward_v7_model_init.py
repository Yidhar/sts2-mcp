#!/usr/bin/env python3
"""Launch the reviewed v41 budget-64 / reward-v7 lineage.

The immutable model source is v39's fully byte-verified healthy anchor at
local step 50,261.  V41 changes the reward identity, so this is explicit model
initialization, never exact resume.  A pinned cross-process attestation reuses
...
def _load_base() -> Any:
    ...
    module_name = "_sts2_v41_budget64_reward_v7_model_init_base"
...
RUN_NAME = "full-run-revival-v41-budget64-reward-v7-model-init"
...
CONFIG_FILE = "full_run_revival_v41_budget64_reward_v7_model_init.toml"
LINEAGE_LABEL = "v41"

SCHEMA_VERSION = "sts2-v41-budget64-reward-v7-model-init-preflight-v1"
STATE_SCHEMA_VERSION = "sts2-v41-budget64-reward-v7-model-init-state-v1"
SUPERVISED_SCHEMA_VERSION = (
    "sts2-v41-budget64-reward-v7-model-init-supervised-launch-v1"
)
SUPERVISED_STATE_SCHEMA_VERSION = (
    "sts2-v41-budget64-reward-v7-model-init-supervised-state-v1"
)
