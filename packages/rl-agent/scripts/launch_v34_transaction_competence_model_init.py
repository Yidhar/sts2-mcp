#!/usr/bin/env python3
"""Launch the reviewed v34 transaction-competence model-init lineage.

The immutable source is the healthy v33 evaluation anchor at environment step
75,714. Network parameters and mature entropy/epsilon/liveness clocks are
inherited. Optimizer, both replay stores, RNG, actor queue and local counters
restart under config-v14; exact resume from the v33 source is forbidden.
"""
...
def _load_base() -> Any:
    ...
    module_name = "_sts2_v34_transaction_competence_model_init_base"
...
SOURCE_RUN_ID = "6c7e939a-9b11-4624-8847-77a8d71631ab"
SOURCE_ENVIRONMENT_STEPS = 75_714
...
SOURCE_CHECKPOINT_ID = "1c412b44-c288-4278-b2e0-373bf9d20a5e"
SOURCE_MANIFEST_SHA256 = "e26f3f464ea0e3f5c960e34628e0ccf165f225a3c6f061b735b3ea8511861ac9"
SOURCE_METADATA_SHA256 = "014a2bf0e79b1e7ff9c6ac4db62943280a3dece85ad6d3d7e9f3065d4347d487"
SOURCE_POLICY_VERSION = 1227
SOURCE_LEARNER_UPDATES = 1227
SOURCE_CHECKPOINT_RELATIVE = Path(
    "checkpoints/full-run-revival-v33-rocdxg-exact-continuation-100k"
...
SCHEMA_VERSION = "sts2-v34-transaction-competence-model-init-preflight-v1"
STATE_SCHEMA_VERSION = "sts2-v34-transaction-competence-model-init-state-v1"
SUPERVISED_SCHEMA_VERSION = "sts2-v34-transaction-competence-model-init-supervised-launch-v1"
SUPERVISED_STATE_SCHEMA_VERSION = "sts2-v34-transaction-competence-model-init-supervised-state-v1"
...
def build_supervisor_command(
    ...
    *,
    ...
    """Re-enter this adapter so the immutable v34 pins remain bound."""
