...
from sts2_env.objective_heads import NUM_OBJECTIVE_HEADS, scalarize_objective_components_torch
...
from legacy.sts2_env.semantic_rollout import SEMANTIC_ROLLOUT_FEAT_DIM, SEMANTIC_ROLLOUT_SIZE
