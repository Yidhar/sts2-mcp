"""Legacy routed candidate-scoring STS2 online RL model definition.

This file is kept for backward compatibility and legacy checkpoints.
The mainline live acting model now lives in ``omni_attention_policy.py``.

Historically this file was the source of truth for:
