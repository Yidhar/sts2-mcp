...
``game-data/generated/card_effect_profiles.generated.json``.
...
PROFILES_PATH = REPO_ROOT / "game-data" / "generated" / "card_effect_profiles.generated.json"
...
"""
    ...
    SCHEMA_OUT.write_bytes((text.rstrip() + "\n").encode("utf-8"))
