...
def test_v37_keeps_v36_transaction_corridor_and_repairs_liveness_plane() -> None:
    ...
    assert REVIVAL_EFFICIENCY_REWARD_SPEC.version == "sts2-run-survival-efficiency-v6"
    assert REVIVAL_EFFICIENCY_REWARD_SPEC.revival_linear_weight == pytest.approx(0.010)
    assert REVIVAL_EFFICIENCY_REWARD_SPEC.revival_quadratic_weight == pytest.approx(0.0009)
