...
archives.  They still spell out the operation-specific exploration floors and
completion guidance that config v20 retired, so the strict current parser
...
table/key stripped -- exactly the projection the reviewed v19 -> v20
